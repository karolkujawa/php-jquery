$(function(){
	$('#stalaa').keyup(function(){
		var stala = parseInt($(this).val());
		if(isNaN(stala)){stala=0;}
		stala = stala + 5;
		
		var wynik = stala*57.5/100;
		var wynik2 = stala*62.5/100;
		var wynik3 = stala*67.5/100;
		var wynik4 = stala*72.5/100;
		var wynik5 = stala*75/100;
	...
	$('#stala2a').keyup(function(){
		var stala2 = parseInt($(this).val());
		if(isNaN(stala2)){stala2=0;}
		stala2 = stala2 + 5;
		
		var wynika = stala2*82.5/100;
		var wynika2 = stala2*82.5/100;
		var wynika3 = stala2*82.5/100;
		var wynika4 = stala2*82.5/100;
		var wynika5 = stala2*82.5/100;
	...
	$('#stala3a').keyup(function(){
		var stala3 = parseInt($(this).val());
		if(isNaN(stala3)){stala3=0;}
		stala3 = stala3 + 5;
		
		var wynikb = stala3*67.5/100;
		var wynikb2 = stala3*70/100;
		var wynikb3 = stala3*75/100;
		var wynikb4 = stala3*80/100;
		var wynikb5 = stala3*82.5/100;
	...
	$('#stala4a').keyup(function(){
		var stala4 = parseInt($(this).val());
		if(isNaN(stala4)){stala4=0;}
		stala4 = stala4 + 5;
		
		var wynikc = stala4*72.5/100;
		var wynikc2 = stala4*72.5/100;
		var wynikc3 = stala4*72.5/100;
		var wynikc4 = stala4*72.5/100;
