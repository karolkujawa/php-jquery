$(function(){
	$('#stalaa').keyup(function(){
		...
		var wynik3 = stala*82.5/100;
		var wynik4 = stala*85/100;
		var wynik5 = stala*87.5/100;
	...
	$('#stala2a').keyup(function(){
		...
		var wynika = stala2*72.5/100;
		var wynika2 = stala2*77.5/100;
		var wynika3 = stala2*80/100;
		var wynika4 = stala2*82.5/100;
		var wynika5 = stala2*85/100;
		
		$('#wynika').html(wynika+' kg');
		$('#wynika2').html(wynika2+' kg');
		$('#wynika3').html(wynika3+' kg');
		$('#wynika4').html(wynika4+' kg');
		$('#wynika5').html(wynika4+' kg');
	});
	...
	$('#stala3a').keyup(function(){
		...
		var wynikb2 = stala3*72.5/100;
		var wynikb3 = stala3*75/100;
		var wynikb4 = stala3*77.5/100;
		var wynikb5 = stala3*80/100;
	...
	$('#stala4a').keyup(function(){
		...
		var wynikc = stala4*67.5/100;
		var wynikc2 = stala4*72.5/100;
		var wynikc3 = stala4*75/100;
		var wynikc4 = stala4*77.5/100;
		var wynikc5 = stala4*80/100;
