$(function(){
	$('#stalaa').keyup(function(){
		...
		var wynik = stala*62.5/100;
		var wynik2 = stala*67.5/100;
		var wynik3 = stala*72.5/100;
		var wynik4 = stala*77.5/100;
		var wynik5 = stala*82.5/100;
	...
	$('#stala2a').keyup(function(){
		...
		var wynika = stala2*62.5/100;
		var wynika2 = stala2*67.5/100;
		var wynika3 = stala2*72.5/100;
	...
	$('#stala3a').keyup(function(){
		...
		var wynikb2 = stala3*65/100;
		var wynikb3 = stala3*70/100;
	...
	$('#stala4a').keyup(function(){
		...
		var wynikc2 = stala4*65/100;
		var wynikc3 = stala4*70/100;
		var wynikc4 = stala4*75/100;
