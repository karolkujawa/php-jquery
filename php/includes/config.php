...
$config['db_host'] = 'userdb1'; // Serwer bazy danych
$config['db_user'] = '1140195_IzA'; // Nazwa użytkownika
$config['db_pass'] = 'tUaFXybMC4JJbu'; // Hasło
$config['db_name'] = '1140195_IzA'; // Nazwa bazy danych
